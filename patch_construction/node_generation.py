...
def Parser_main():
    ...
    parser.add_argument("--graphdir",default=r" ",help="graph save dir",type=str)
    parser.add_argument("--imagedir",default=r" ",help="svs file location",type=str)
    parser.add_argument("--weight_path",default=r" ",help="pretrained weight path",type=str)
